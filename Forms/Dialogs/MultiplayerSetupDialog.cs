...
namespace SpinARayan
{
    public class MultiplayerSetupDialog : Form
    {
        ...
        private void BtnBrowse_Click(object? sender, EventArgs e)
        {
            ...
            {
                Description = "Wähle deinen OneDrive/Dropbox Ordner für Multiplayer:",
        ...
        private void BtnSave_Click(object? sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                MessageBox.Show(
                    ...
                    "Bitte erstelle den Ordner manuell oder wähle einen anderen Pfad.",
                    "Fehler",
                    MessageBoxButtons.OK,
            ...
            try
            {
                ...
                string configContent = $"# Multiplayer Config - Auto-Generated\n" +
                                      ...
                                      $"# {(IsAdmin ? "Du kannst Events starten mit 'E' oder 'M'" : "Du empfängst Events vom Admin")}\n";
                ...
                MessageBox.Show(
                    ...
                    (IsAdmin ? "Drücke 'E' oder 'M' im Spiel um Events zu starten!" : "Warte auf Events vom Admin!"),
                    "Setup abgeschlossen",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Information
                );
        ...
        {
            var result = MessageBox.Show(
                "Multiplayer-Setup überspringen?\n\n" +
                "Du kannst es später aktivieren indem du\n" +
