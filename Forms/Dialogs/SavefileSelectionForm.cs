...
namespace SpinARayan.Forms.Dialogs
{
    public partial class SavefileSelectionForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.MinimumSize = new Size(450, 400); // DPI-Aware: Minimale Größe

            // Title
            lblTitle = new Label
            {
                Text = "💾 Savefile auswaehlen",
        ...
        private Panel CreateSavefilePanel(SavefileInfo savefile)
        {
            var panel = new Panel
            {
                Size = new Size(520, 120), // Erh�ht von 100 auf 120 f�r mehr Platz
                BorderStyle = BorderStyle.FixedSingle,
                BackColor = DarkPanel
            };
            ...
            // Stats (mehr Platz f�r Zeilenumbr�che)
            var lblStats = new Label
            {
                Location = new Point(10, 40),
                Size = new Size(400, 70), // Erh�ht von 50 auf 70
            ...
            // Select Button (weiter unten wegen mehr Panel-H�he)
            var btnSelect = new Button
            {
                Location = new Point(420, 60), // von 50 auf 60
                Size = new Size(90, 40), // von 35 auf 40 (gr��erer Button)
                Text = "Auswaehlen",
